...
|---|---|---|
|`payload_en_1-500.jsonl`|`trn1.32xlarge`|The best option for staying within a latency budget of `2 seconds` on a `trn1.32xlarge` for the `payload_en_1-500.jsonl` dataset is a `concurrency level of 20`. A concurrency level of 20 achieves an `median latency of 1.59 seconds`, for an `average prompt size of 274 tokens` and `completion size of 40 tokens` with `729 transactions/minute`.|
|`payload_en_1000-2000.jsonl`|`trn1.32xlarge`|The best option for staying within a latency budget of `2 seconds` on a `trn1.32xlarge` for the `payload_en_1000-2000.jsonl` dataset is a `concurrency level of 20`. A concurrency level of 20 achieves an `median latency of 1.55 seconds`, for an `average prompt size of 1550 tokens` and `completion size of 43 tokens` with `550 transactions/minute`.|
|`payload_en_2000-3000.jsonl`|`trn1.32xlarge`|The best option for staying within a latency budget of `2 seconds` on a `trn1.32xlarge` for the `payload_en_2000-3000.jsonl` dataset is a `concurrency level of 14`. A concurrency level of 14 achieves an `median latency of 1.43 seconds`, for an `average prompt size of 2520 tokens` and `completion size of 51 tokens` with `391 transactions/minute`.|
|`payload_en_3000-3840.jsonl`|`trn1.32xlarge`|The best option for staying within a latency budget of `2 seconds` on a `trn1.32xlarge` for the `payload_en_3000-3840.jsonl` dataset is a `concurrency level of 14`. A concurrency level of 14 achieves an `median latency of 1.33 seconds`, for an `average prompt size of 3433 tokens` and `completion size of 41 tokens` with `410 transactions/minute`.|
|`payload_en_500-1000.jsonl`|`trn1.32xlarge`|The best option for staying within a latency budget of `2 seconds` on a `trn1.32xlarge` for the `payload_en_500-1000.jsonl` dataset is a `concurrency level of 20`. A concurrency level of 20 achieves an `median latency of 1.72 seconds`, for an `average prompt size of 827 tokens` and `completion size of 47 tokens` with `675 transactions/minute`.|
