...
CONFIG_FILE_PATH=src/fmbench/configs/llama3.1/8b/config-llama3.1-8b-trn32xl-triton.yml
#src/fmbench/configs/llama3.1/8b/config-llama3.1-8b-g5.2xl-tp-1-mc-max-ec2.yml
